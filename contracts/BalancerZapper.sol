...
contract BalancerZapper {
    ...
    function joinPool(
        ...
        bytes memory userDataEncoded =
            abi.encode(JoinKind, _amountsIn, _minOut);
        (address[] memory poolTokens, , ) =
            balancerVault.getPoolTokens(_poolId);
        JoinPoolRequest memory jpr =
            JoinPoolRequest(poolTokens, _amountsIn, userDataEncoded, false);
